...
export default function Home() {
  return (
    <section name="home" className='flex w-full h-screen bg-zinc-200'>
      <div className=' grid md:grid-cols-2 max-x-[1240px] m-auto'>
        ...
        <div className='flex flex-col justify-center px-2'>
          ...
          Most Useful Chat Platform You've ever met.<br/>
          I recommend our platform because of it's function.<br/>
          I believe You definitely like this platform.<br/>
          Come get Use.
          </p>

    ...
    <nav className="w-screen h-[80px] z-10 bg-zinc-200 fixed drop-shadow-lg">
        <div className="flex items-center justify-between w-full h-full px-10">
            <div className="flex items-center">
                ...
                <ul className="hidden md:flex">
                    <li><Link onClick={()=> setNav(false)} to="home" smooth={true} duration={500}>Home</Link></li>
                    <li><Link onClick={()=> setNav(false)} to="about" smooth={true} duration={500}>About</Link></li>
                    <li><Link onClick={()=> setNav(false)} to="support" smooth={true} duration={500}>Support</Link></li>
                    <li><Link onClick={()=> setNav(false)} to="feature" smooth={true} duration={500}>Feature</Link></li>
                    <li><Link onClick={()=> setNav(false)} to="feedback" smooth={true} duration={500}>Feedback</Link></li>
                </ul>
            </div>
        ...
        >
            ...
            <div className="flex flex-col my-4">
                <button className="px-8 py-3 mb-4 text-black bg-transparent border-none">
                Sign In
                </button>
            <button className="px-8 py-3">Sign Up</button>
            </div>

    ...
    <div name='support' className='w-full mt-24'>
        ...
        <div className='max-w-[1240px] mx-auto text-white relative'>
            <div className='px-4 py-12'>
                ...
                <p className='py-4 text-3xl text-slate-300'>Lorem ipsum dolor sit amet consecteturr adispalsdidfu elit. Ecvspoerj Lorem ipsum dolor sit amet consecteturr adispalsdidfu elit. Ecvspoerj Lorem ipsum dolor sit amet consecteturr adispalsdidfu elit. Ecvspoerj</p>
            </div>

            <div className='grid grid-cols-1 px-4 pt-12 text-black lg:grid-cols-3 gap-x-8 gap-y-16 sm:py-20'>
                <div className='bg-white shadow-2xl rounded-xl'>
                    <div className='p-8'>
                        <h3 className='my-6 text-2xl font-bold'>Support</h3>
                        <p className='text-xl text-gray-600'>Lorem ipsum dolor sit amet consecteturr adispalsdidfu elit. Ecvspoerj</p>
                    </div>
